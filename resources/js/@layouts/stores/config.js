...
export const useLayoutConfigStore = defineStore('layoutConfig', () => {
  // const route = useRoute() // Removed - not using Vue Router with Inertia
  ...
  const _layoutClasses = computed(() => {
    ...
    return [
      ...
      // route.meta.layoutWrapperClasses ? route.meta.layoutWrapperClasses : null, // Removed - not using Vue Router
    ]
  })
