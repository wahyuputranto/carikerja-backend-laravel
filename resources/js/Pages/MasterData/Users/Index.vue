...
watch(search, debounce((value) => {
    router.get(route('master-data.users.index'), { search: value }, {
        preserveState: true,
        replace: true,
    });
}, 300));
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="md:hidden space-y-4">
                        <div v-for="item in users.data" :key="item.id" class="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
                        ...
                        <div v-if="users.data.length === 0" class="text-center text-gray-500 dark:text-gray-400 py-4">
                            No users found.
                        </div>
                    </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 hidden md:table">
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            <tr v-for="item in users.data" :key="item.id" class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                ...
                <Pagination v-if="users.links" :links="users.links" :from="users.from" :to="users.to" :total="users.total" />
            </div>
        </div>
