            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="md:hidden space-y-4">
                        <div v-for="item in skills.data" :key="item.id" class="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
                        ...
                        <div v-if="skills.data.length === 0" class="text-center text-gray-500 dark:text-gray-400 py-4">
                            No skills found.
                        </div>
                    </div>
