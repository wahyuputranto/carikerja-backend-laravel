            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4 md:gap-0">
                ...
                <div class="flex flex-col md:flex-row items-stretch md:items-center space-y-3 md:space-y-0 md:space-x-4 w-full md:w-auto">
                    <div class="relative">
                        <select
                            v-model="typeFilter"
                            class="w-full md:w-40 px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 focus:ring-primary-500 focus:border-primary-500"
                        >
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="md:hidden space-y-4">
                        <div v-for="item in locations.data" :key="item.id" class="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
                            <div class="flex justify-between items-start mb-3">
                                <div>
                                    <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100">{{ item.name }}</h3>
                                    <p class="text-sm text-gray-500 dark:text-gray-400 font-mono">{{ item.type }}</p>
                                </div>
                        ...
                        <div v-if="locations.data.length === 0" class="text-center text-gray-500 dark:text-gray-400 py-4">
                            No locations found.
                        </div>
                    </div>
